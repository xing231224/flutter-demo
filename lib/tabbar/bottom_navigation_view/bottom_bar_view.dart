...
class BottomBarView extends StatefulWidget {
  const BottomBarView({Key? key, this.tabIconsList, this.changeIndex, this.addClick, this.isLabel = false})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
            ...
            return Transform(
              ...
              child: PhysicalShape(
                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(
                      height: widget.isLabel ? 70 : 62, // 62
                      child: Padding(
                        padding: EdgeInsets.only(left: 8, right: 8, top: 4, bottom: widget.isLabel ? 10 : 0),
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              child: TabIcons(
                                  label: widget.isLabel ? '任务' : null,
        ...
        Padding(
          padding: EdgeInsets.only(bottom: MediaQuery.of(context).padding.bottom + (widget.isLabel ? 8 : 0)),
          child: SizedBox(
            width: 38 * 2.0,
            height: 38 + 62.0,
            child: Container(
...
class TabIcons extends StatefulWidget {
  const TabIcons({Key? key, this.tabIconData, this.removeAllSelect, this.label}) : super(key: key);
  final String? label;
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: ScaleTransition(
                    alignment: Alignment.center,
                    scale: Tween<double>(begin: 1, end: .5).animate(CurvedAnimation(
                        parent: widget.tabIconData!.animationController!,
                        curve: Interval(0.5, 0.6, curve: Curves.fastOutSlowIn))),
                    child: Offstage(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 11,
                              color: widget.tabIconData!.isSelected ? AppTheme.nearlyDarkBlue : Colors.grey),
                        )),
                  ),
                ),
              ],
